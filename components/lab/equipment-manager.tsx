...
// Client manager
//
// Seeded with server-fetched equipment (`initialMachines`) so the grid is in
// the initial HTML. `loadMachines` is still used to refresh after a
...
export function EquipmentManager({
  ...
  initialMachines: MachineryWithStatus[]
}) {
  const [machines, setMachines] = useState<MachineryWithStatus[]>(initialMachines)
